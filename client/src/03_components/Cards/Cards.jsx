...
import { FILTER_BY_MENOR_CINCUENTA ,LESS_POPULATION, HIGHER_POPULATION, ALL, ALL_OF_AFRICA, ALL_OF_N_AMERICA, ALL_OF_S_AMERICA, ALL_OF_ANTARCTICA, ALL_OF_ASIA, ALL_OF_EUROPE, ALL_OF_OCEANIA, ASCENDENTE, DESCENDENTE} from "../../04_const/Const";
    ...
    <div className="cardsContainer">
      ...
      <button id='b1' className='filterAndOrder' onClick={(e)=>reloadButton(e)}>Recargar</button>
        ...
        >
          ...
          <option value={FILTER_BY_MENOR_CINCUENTA}>Poblacion Menor a 50.000</option>
        </select>
        //
